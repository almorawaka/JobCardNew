...
//select data for jobcard headder informations
$select = "SELECT * FROM `institutes` ORDER BY `Job_id` DESC LIMIT 1 ";
//$select = "SELECT * FROM `institutes` WHERE `Job_id` = 95";
...
//1
// // select data form spateparts
// //$select2 = "SELECT * FROM `spareparts` ORDER BY Job_id DESC LIMIT 1,1 ";
// $seelct2 = "SELECT * FROM `spareparts` WHERE `Job_id`= '$job_id' ";
...
// $pdf->Cell(27 ,5,'',1,0,'C');
// $pdf->Cell(20 ,5,$stock_no,1,0,'C');
// $pdf->Cell(20 ,5,$qty,1,0,'C');
// $pdf->Cell(47 ,5,$description,1,0,'C');
// $pdf->Cell(12 ,5,'',1,0,'C');
// $pdf->Cell(27 ,5,'',1,0,'C');
// $pdf->Cell(20 ,5,'',1,0,'C');
// $pdf->Cell(20 ,5,'',1,1,'C');
